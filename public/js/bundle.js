...
var stripe = Stripe('pk_test_51HnekJBr1cMCuPsjcBY6kgOKAP3dd9sBaat1oEJBmPHXAZJJPnrnPLdh9M5lGS1Gt1DGgImKRzUUPgITs3IJYIau005xc4zQvk');

var booknow = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/booking/checkout-sessions/".concat(tourID));
          ...
          case 8:
            ...
            (0, _alert.default)('err', _context.t0);
...
var signupBtn = document.querySelector('.navigation__content--signup');
var loginBtn = document.querySelector('.navigation__content--login');
var sectionLogin = document.querySelector('.section__login');
...
var book = document.querySelector('.book_tour');
...
if (tourHeader) {
  var image = tourHeader.dataset.image;
  tourHeader.style.backgroundImage = "url(/img/combine/".concat(image, ")");
}
...
if (book) {
  book.addEventListener('click', function (e) {
    ...
    var tourID = book.dataset.tourId;
    (0, _stripe.booknow)(tourID);
  });
}
